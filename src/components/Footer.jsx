...
export default function Footer () {
    return (
        <div className="flex flex-col md:gap-16 md:p-20 sm:gap-8 sm:p-10 xs:gap-4 xs:p-4 bg-footer dark:bg-foo" >
            <h2 className="font-Inter font-semibold lg:text-5xl lg:w-1/3 text-left md:text-3xl sm:text-2xl xs:w-full xs:text-lg dark:text-h1 text-r-black">Let's work together on your next product.</h2>
            <div className="flex justify-between items-center">
                ...
                <div className="flex md:gap-6 xs:gap-2">
                    <p className="font-medium font-Inter lg:text-lg md:text-base xs:text-xs dark:text-btn-t text-r-black">Personal Blog</p>
