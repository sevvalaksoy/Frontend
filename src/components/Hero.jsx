        ...
        <div className="flex justify-between sm:flex-row h-2/5 md:gap-20 items-center md:mb-20 xs:gap-8 xs:flex-col">
            <div className="flex flex-col lg:w-7/12 h-6/12 md:gap-10 md:w-9/12 xs:gap-2"> 
                ...
                <div className="flex lg:gap-6 items-start xs:gap-4">
                    <button className="border-solid border-[1px] bg-borderC dark:bg-btn-lilac rounded-md lg:text-lg font-Inter lg:font-medium dark:text-r-black text-white cursor-pointer lg:py-3 lg:px-8 md:text-base md:py-[9px] md:px-2 xs:text-sm xs:px-2 xs:py-2">Hire me</button>
