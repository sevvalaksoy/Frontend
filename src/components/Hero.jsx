    ...
    return (
        <div className="flex justify-between sm:flex-row h-2/5 md:gap-20 items-center md:mb-20 xs:gap-8 xs:flex-col">
            <div className="flex flex-col lg:w-7/12 h-6/12 md:gap-10 md:w-9/12 xs:gap-2"> 
                ...
                <h1 className="font-Inter font-bold lg:text-7xl text-left md:text-3xl sm:text-2xl xs:text-lg dark:text-h1 text-black">Creative thinker Minimalism lover</h1>
                <p className="font-normal font-Inter lg:text-lg text-left md:text-sm xs:text-xs dark:text-white text-gray2">Hi, I’m Şevval. I’m a full-stack developer. If you are looking for a Developer who to craft solid and scalable frontend products with great user experiences. Let’s shake hands with me.</p>
                <div className="flex lg:gap-6 items-start xs:gap-4">
                    <button onClick={()=>history.push("/contact")} className="border-solid border-[1px] bg-borderC dark:bg-btn-lilac rounded-md lg:text-lg font-Inter lg:font-medium dark:text-r-black text-white cursor-pointer lg:py-3 lg:px-8 md:text-base md:py-[9px] md:px-2 xs:text-sm xs:px-2 xs:py-2">Hire me</button>
                    ...
                    <a href="https://www.linkedin.com/in/şevval-aksoy-8a54811b9/" className={`border-solid border-[1px] border-borderC dark:border-btn-lilac dark:bg-btn-bcg dark:text-btn-lilac flex items-center lg:gap-2 rounded-md lg:text-lg font-Inter font-medium text-purple2 cursor-pointer lg:py-3 lg:px-4 md:py-2 md:px-2 md:gap-1 xs:text-sm xs:px-2 xs:py-[4px] xs:gap-1  ${!theme ? " border-btn-lilac bg-btn-bcg ": ""}`}> 
