    ...
    return (
        <div className="flex justify-between items-center"> 
            ...
            <div className="flex justify-between md:gap-5 xs:gap-2 ">
                <button onClick={()=>history.push("/skills")} data-cy="skills-button" className="md:text-lg font-Inter font-medium text-gray2 cursor-pointer md:py-3 md:px-8 sm:py-1 sm:px-5 xs:text-base">{info.header.bir}</button>
