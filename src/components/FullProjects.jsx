...
export default function FullProjects () { 
    ...
    if (isPending) return <h3 className="font-Inter md:text-2xl font-medium text-center sm:text-lg xs:text-base dark:text-pr text-purple">Please Wait While the Projects are Loading...</h3>;
        ...
        <div className="flex flex-col items-start w-full gap-10 py-12">
            ...
            <div className="w-full flex flex-wrap sm:flex-row xs:flex-col justify-between sm:gap-4 xs:gap-10">
                <div className="flex flex-col items-start sm:w-[30%] gap-4 pb-20">
                    ...
                    <h3 className="font-Inter md:text-3xl font-medium text-left sm:text-lg xs:text-base dark:text-pr text-purple">Office</h3>
