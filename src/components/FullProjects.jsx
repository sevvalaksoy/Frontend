        ...
        <div className="flex flex-col items-start w-full gap-10 py-12">
            ...
            <div className="w-full flex flex-wrap sm:flex-row xs:flex-col justify-between sm:gap-4 xs:gap-10">
                <div className="flex flex-col items-start sm:w-[30%] gap-4 pb-20">
                    ...
                    <h3 className={`font-Inter md:text-3xl font-medium text-left sm:text-lg xs:text-base ${!theme? "text-pr":"text-purple"}`}>Office</h3>
                    ...
                    <div className="flex lg:gap-4 md:gap-2 xs:gap-1">
                        <button className={`border-solid border-[1px] rounded-md lg:text-lg md:text-sm font-Inter font-medium md:py-1 md:px-4 xs:text-xs xs:px-2 xs:py-0 ${!theme? "text-ş border-btn-ş bg-btn-bcg":"text-purple2 border-borderC "}`}>SQL</button>
                    </div>
                    <div className="flex justify-between w-full">
                        <a className={`font-Inter font-medium cursor-pointer underline md:text-base xs:text-xs  ${!theme? "text-btn-t":"text-purple2"}`} href="https://www.amazon.com.tr/b?node=60457475031">View Site</a>
                    </div>
                </div>
