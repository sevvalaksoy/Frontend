...
export default function Projects () {
    ...
    return (
        <div className="flex flex-col items-start w-full gap-10 py-12">
            ...
            <h2 className={`font-Inter font-semibold text-5xl text-black ${!theme?"text-h1":""}`}>Projects</h2> 
            <div className="w-full flex justify-between">
                <div className="flex flex-col items-start w-[30%] gap-4 ">
                    ...
                    <p className={`font-Inter font-normal text-sm text-gray2 text-left ${!theme?"text-white":""}`}>A simple, customizable, minimal setup cookie plugin that allows your users to select which cookies to accept or decline. This was created with vanilla JS, SCSS and Parcel Bundler and is available as a NPM package and the git repository makes any type of customization to code and themes possible.</p>
                    <div className="flex gap-4">
                        <div className={`border-solid border-[1px] rounded-md text-lg font-Inter font-medium py-1 px-4 ${!theme? "text-ş border-btn-ş bg-btn-bcg":"text-purple2 border-borderC "}`}>react</div>
                        <div className={`border-solid border-[1px] rounded-md text-lg font-Inter font-medium py-1 px-4 ${!theme? "text-ş border-btn-ş bg-btn-bcg":"text-purple2 border-borderC "}`}>redux</div>
                        <div className={`border-solid border-[1px] rounded-md text-lg font-Inter font-medium py-1 px-4 ${!theme? "text-ş border-btn-ş bg-btn-bcg":"text-purple2 border-borderC "}`}>axios</div>
                    </div>
